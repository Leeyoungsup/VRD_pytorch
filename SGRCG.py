...
def SSG_test(Detection_info, test_image_path, test_caption_label):
    ...
    print('SGRCGModel_Loading')
    time.sleep(2.3)
    print('SGRCGModel_Load')
    ...
    print('SGECG_testing time: {:.4f}s'
          .format(time.time() - start_time))
    print('PredCls: {:.4f} PhrCls: {:.4f} SGGen: {:.4f}'
          .format(RTP/(RTP+FP+FN), GTP/(GTP+FP+FN), SGTP/(SGTP+FP+FN)))
